...
export class VentrixDBServiceService {
  ...
  constructor(private httpClient: HttpClient) { }
    ...
    createUser(obj:any): Observable<any[]> {
      return this.httpUser.post<any>('https://localhost:44317/api/User/createUser',obj)
    }

    //Returns users from API
    readUser(): Observable<User[]> {
      return this.httpUser.get<User[]>('https://localhost:44317/api/User/getUsers')
    }
    
    //Updates users from API
    updateUser(obj:any): Observable<any[]> {
      return this.httpUser.post<any>('https://localhost:44317/api/User/updateUser',obj)
    }

    //Deletes user from API
    deleteUser(obj:any): Observable<any[]> {
      return this.httpUser.post<any>('https://localhost:44317/api/User/deleteUser',obj)
    }
