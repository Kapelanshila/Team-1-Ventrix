...
export class VentrixDBServiceService {
  ...
  constructor(private httpClient: HttpClient) { }
    ...
    createWarehouse(obj:any): Observable<any[]> {
      return this.httpClient.post<any>('https://localhost:44317/api/Warehouse/createWarehouse',obj)
    }

    //Returns Warehouses from API
    readWarehouse(): Observable<Client[]> {
      return this.httpClient.get<Client[]>('https://localhost:44317/api/Warehouse/getWarehouse')
    }
    
    //Updates Warehouse from API
    updateWarehouse(obj:any): Observable<any[]> {
      return this.httpClient.post<any>('https://localhost:44317/api/Warehouse/updateWarehouse',obj)
    }

    //Deletes Warehouse from API
    deleteWarehouse(obj:any): Observable<any[]> {
      return this.httpClient.post<any>('https://localhost:44317/api/Warehouse/deleteWarehouse',obj)
    }
    ...
    clearWarehouse()
    {
     ...
     createWarrantyPeriod(obj:any): Observable<any[]> {
       return this.httpClient.post<any>('https://localhost:44317/api/WarrantyPeriod/createWarrantyPeriod',obj)
     }
 
     //Returns WarrantyPeriods from API
     readWarrantyPeriod(): Observable<WarrantyPeriod[]> {
       return this.httpClient.get<WarrantyPeriod[]>('https://localhost:44317/api/WarrantyPeriod/getWarrantyPeriod')
     }
     
     //Updates WarrantyPeriod from API
     updateWarrantyPeriod(obj:any): Observable<any[]> {
       return this.httpClient.post<any>('https://localhost:44317/api/WarrantyPeriod/updateWarrantyPeriod',obj)
     }
 
     //Deletes WarrantyPeriod from API
     deleteWarrantyPeriod(obj:any): Observable<any[]> {
       return this.httpClient.post<any>('https://localhost:44317/api/WarrantyPeriod/deleteWarrantyPeriod',obj)
     }
