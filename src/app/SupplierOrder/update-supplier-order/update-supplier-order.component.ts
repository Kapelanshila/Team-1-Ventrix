...
export class UpdateSupplierOrderComponent implements OnInit {
  ...
  editSupplierOrder()
  {
    ...
    .subscribe(response => {
      ...
      if (this.supplierorderform.valid && this.selectedSupplier && this.selectedorder.supplierId && this.supplierorderform.dirty && this.supplierorderform.get('description')?.value != this.selectedorder.description)
      {
