...
export class PackOrderComponent implements OnInit {
            ...
            response.forEach(element => {
             if (element.clientId == clientorder.clientId)
             {
              ...
              .subscribe(response => {
                ...
                if (this.temp.description == "Processed")
                {
                  this.order = 
                  {
  ...
  packOrder(selectedClientOrder: ClientOrderVM)
  {
    Swal.fire({
      icon: 'question',
      title: 'Are you sure you want to pack this Client Order?',
      showDenyButton: true,
      ...
      if (result.isConfirmed) {
        Swal.fire({
          icon: 'success',
          title: 'Client Order Successfully Packed',
          ...
          if (result.isConfirmed) {
            this.ventrixdbservice.packOrder(selectedClientOrder).subscribe();
            this.router.navigate(['/pack-order']).then(() => {
