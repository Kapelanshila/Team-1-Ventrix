...
export class DriverAuthGuard implements CanActivate {
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree 
    {
      ...
      if (this.tokenStorageService.getToken != undefined && (this.account.role == "Admin" || this.account.role == "Master" || this.account.role == "Driver" || this.account.role == "Management" || this.account.role == "Warehouse"))
      {
        return true;
      }
      else
