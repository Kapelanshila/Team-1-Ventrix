...
export class AssignAuthGuard implements CanActivate {
  account!:Account;
  constructor(
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree 
    {
      ...
      if (this.tokenStorageService.getToken != undefined && (this.account.role == "Admin" || this.account.role == "Master" || this.account.role == "Management"))
      {
        return true;
      }
      else
